# -*- coding: UTF-8 -*-
import re, os, time, uuid, shortuuid, random, hashlib, zlib, base64, qrcode, datetime, subprocess
...
def get_serial_wwid(serial_name):
    serial = subprocess.check_output("ls /dev/disk/by-uuid -al", shell=True)
    wwid = ''
