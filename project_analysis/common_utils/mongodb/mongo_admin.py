...
# import sys
# sys.path.append('/www/project_analysis')
# from project_analysis3 import ProjectConfig
...
# print(db.createUser(ProjectConfig.MONGODB_DB, ProjectConfig.MONGODB_USERNAME, ProjectConfig.MONGODB_PASSWORD, role=[Roles.dbOwner]))
